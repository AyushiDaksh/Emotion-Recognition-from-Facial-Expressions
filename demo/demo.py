...
with open("performance_log.csv", "w") as log_file:
    log_file.write("Timestamp,Frame Time (s),FPS,Latency (s),CPU Utilization (%),GPU Utilization (%)\n")
    ...
    while True:
        ...
        log_file.write(f"{timestamp},{frame_time},{fps},{latency},{cpu_usage},{gpu_usage}\n")
        log_file.flush()
